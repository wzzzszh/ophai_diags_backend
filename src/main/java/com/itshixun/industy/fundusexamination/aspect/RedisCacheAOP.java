...
public class RedisCacheAOP {
    ...
    @Pointcut("@annotation(com.itshixun.industy.fundusexamination.annotation.AddCache)")
    public void addCache() {

    }
    @Pointcut("@annotation(com.itshixun.industy.fundusexamination.annotation.DelCache)")
